...
_HERMES_CORE_TOOLS = [
    ...
    "send_message",
    # Zulip thread history — gated on ZULIP credentials via check_fn
    "zulip_read_thread",
...
TOOLSETS = {
    ...
    "hermes-zulip": {
        "description": "Zulip bot toolset - self-hosted team messaging with streams + topics (full access)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
